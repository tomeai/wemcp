...
from backend.common.security.jwt import jwt_verify
...
class JwtAuthMiddleware(AuthenticationBackend):
    ...
    async def authenticate(self, request: Request) -> tuple[AuthCredentials, dict] | None:
        """
        认证请求
